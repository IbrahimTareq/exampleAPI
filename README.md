...
[![Build Status](https://travis-ci.org/IbrahimTareq/exampleAPI.svg?branch=master)](https://travis-ci.org/IbrahimTareq/exampleAPI)
...
6. If you did everything correct, https://ibrahimtareq.github.io/exampleAPI/ will lead to your new docs
...
- Documentation(ReDoc): https://ibrahimtareq.github.io/exampleAPI/
- SwaggerUI: https://ibrahimtareq.github.io/exampleAPI/swagger-ui/
- Look full spec:
    + JSON https://ibrahimtareq.github.io/exampleAPI/swagger.json
    + YAML https://ibrahimtareq.github.io/exampleAPI/swagger.yaml
- Preview spec version for branch `[branch]`: https://ibrahimtareq.github.io/exampleAPI/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://ibrahimtareq.github.io/exampleAPI/ with url from the message: `Server started <url>`
